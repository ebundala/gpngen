...
export class CONSUMER extends Role {
    ...
    constructor() {
        ...
        //             "select.organizations.id",
        //             "select.organizations.name",
        //             "select.organizations.description",
        //             "select.organizations.logo.id",
        //             "select.organizations.logo.path",
        //             "select.organizations.logo.mimetype",
        //             'select.organizations.location.id',
        //             'select.organizations.location.name',
        //            // 'select.organizations.location.latlon',
        //             'select.staffOf.id',
        //             'select.staffOf.name',
        //             'select.staffOf.logo.id',
        //             'select.staffOf.logo.path',
